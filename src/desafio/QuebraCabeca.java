...
public class QuebraCabeca extends JFrame {
    ...
    public QuebraCabeca() {
        ...
        b1.setBounds(60, 30, 60, 50);
        add(b1);
                
        JButton b2 = new JButton(" ");
        b2.setBounds(120, 30, 60, 50);
        add(b2);
        
        JButton b3 = new JButton("3");
        b3.setBounds(180, 30, 60, 50);
        add(b3);
        
        JButton b4 = new JButton("4");
        b4.setBounds(60, 90, 60, 50);
        add(b4);
        
        JButton b5 = new JButton("5");
        b5.setBounds(120, 90, 60, 50);
        add(b5);
        
        JButton b6 = new JButton("6");
        b6.setBounds(180, 90, 60, 50);
        add(b6);
        
        JButton b7 = new JButton("7");
        b7.setBounds(60, 150, 60, 50);
        add(b7);
        
        JButton b8 = new JButton("8");
        b8.setBounds(120, 150, 60, 50);
        add(b8);
        
        JButton b9 = new JButton("2");
        b9.setBounds(180, 150, 60, 50);
        add(b9);
        
        JButton next = new JButton("Next");
        next.setBounds(100, 225, 120, 50);
        add(next);
